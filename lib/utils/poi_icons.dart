...
class POIIcons {
  ...
  static String _getPOIIconInternal(String type) {
  ...
  static String _getHazardIconInternal(String type) {
    switch (type.toLowerCase()) {
      case 'pothole':
        return '🕳️';
      case 'construction':
  ...
  static IconData _getPOIMaterialIconInternal(String type) {
    switch (type.toLowerCase()) {
      case 'bike_shop':
        return Icons.store;
      case 'bike_repair':
  ...
  static IconData _getHazardMaterialIconInternal(String type) {
    switch (type.toLowerCase()) {
      case 'pothole':
